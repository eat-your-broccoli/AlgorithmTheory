 ...
 *
 *  2. Write an ecient Java program that reads a natural number n from the input and then
 * computes the number a(n) of binary words of length n with at least two 0-digits between
 * two 1-digits.
 *
 *  3. Write an ecient Java program that reads a natural number n and a positive natural
